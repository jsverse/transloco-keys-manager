...
import { createTranslationFiles } from '../src/keys-builder/create-translation-files';
import { runPrettier } from '../src/keys-builder/utils/run-prettier';
import { getLogger } from '../src/utils/logger';
import { buildTranslationFile } from '../src/keys-builder/build-translation-file';
import { ScopeMap } from '../src/types';
...
vi.mock('../src/keys-builder/utils/run-prettier', () => ({
  runPrettier: vi.fn().mockResolvedValue(undefined),
}));

vi.mock('../src/keys-builder/build-translation-file', () => ({
